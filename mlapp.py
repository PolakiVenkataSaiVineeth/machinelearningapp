...
if uploaded_file is not None:
    ...
    # Combine the numeric and non-numeric columns (non-numeric data remains unchanged)
    ...
    features = [col for col in numeric_data.columns if col != target]  # Only use numeric features
