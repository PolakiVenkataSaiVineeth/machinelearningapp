...
# Load dataset directly from your file (Update path if necessary)
csv_path = 'C:/Users/hp/Documents/Student_Performance.csv' # This is your dataset file provided earlier
